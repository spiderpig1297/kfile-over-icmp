...
- It is by far more stealth than a user-mode program. There is no network-related system-command (`iptables`, `netstat`, etc) that will ever be able to know that a driver listens on ICMP and injects data on the replies.
